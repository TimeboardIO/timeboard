    ...
    data: {
        ...
        table: {
            ...
            filters: {
               ...
               start:     { filterKey: 'startDate',        filterValue: '',     filterFunction: function(filter, row) { return new Date(row).getTime() > new Date(filter).getTime()}},
               end:       { filterKey: 'endDate' ,         filterValue: '',     filterFunction: function(filter, row) { return new Date(row).getTime() < new Date(filter).getTime() }},
               oeMin:     { filterKey: 'originalEstimate', filterValue: '',     filterFunction: function(filter, row) { return parseFloat(row) >= parseFloat(filter)  }},
               oeMax:     { filterKey: 'originalEstimate', filterValue: '',     filterFunction: function(filter, row) { return parseFloat(row) <= parseFloat(filter) }},
               assignee:  { filterKey: 'assignee',         filterValue: '',     filterFunction: function(filter, row) { return row.toLowerCase().indexOf(filter.toLowerCase()) > -1 }},
               status:    { filterKey: 'status',           filterValue: '',     filterFunction: function(filter, row) { return row.toLowerCase().indexOf(filter.toLowerCase()) > -1 }},
               milestone: { filterKey: 'milestoneID',      filterValue: '',     filterFunction: function(filter, row) { return row.toLowerCase().indexOf(filter.toLowerCase()) > -1 }},
               type:      { filterKey: 'typeID',           filterValue: '',     filterFunction: function(filter, row) { return row.toLowerCase().indexOf(filter.toLowerCase()) > -1 }},
            },
            data: [],
            name: 'tableTask',
            configurable : true
